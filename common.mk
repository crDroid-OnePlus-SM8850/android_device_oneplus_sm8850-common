...
ifeq ($(filter %_infiniti,$(TARGET_PRODUCT)),)
PRODUCT_COPY_FILES += \
    vendor/oneplus/sm8850-common/proprietary/odm/lib64/libsensorbridge.so:$(TARGET_COPY_OUT_ODM)/lib64/libsensorbridge.so
endif
